package pt.jmnpedrosa.samples.springboot.async.swagger.config;
...
public class SwaggerConfig {
  ...
  public Docket api() {
    ...
    return new Docket(DocumentationType.SWAGGER_2)
        .apiInfo(metaData())
        .select()
        .apis(RequestHandlerSelectors.basePackage("pt.jmnpedrosa.samples.springboot.async.web"))
  ...
  private ApiInfo metaData() {
    return new ApiInfoBuilder()
        .title("Spring Boot Async Sample")
        .description("A demo of a RESTful service for managing async background tasks.")
